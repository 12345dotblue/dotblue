...
DOTBLUE_FILES_DRIVER="${DOTBLUE_FILES_DRIVER:-local}"
DOTBLUE_FILES_LOCAL_ROOT="${DOTBLUE_FILES_LOCAL_ROOT:-/app/storage/chat-files}"
DOTBLUE_FILES_HOST_PATH="${DOTBLUE_FILES_HOST_PATH:-./.runtime/chat-files}"
DOTBLUE_S3_ENDPOINT="${DOTBLUE_S3_ENDPOINT:-}"
DOTBLUE_S3_REGION="${DOTBLUE_S3_REGION:-us-east-1}"
DOTBLUE_S3_BUCKET="${DOTBLUE_S3_BUCKET:-}"
DOTBLUE_S3_ACCESS_KEY="${DOTBLUE_S3_ACCESS_KEY:-}"
DOTBLUE_S3_SECRET_KEY="${DOTBLUE_S3_SECRET_KEY:-}"
DOTBLUE_S3_SESSION_TOKEN="${DOTBLUE_S3_SESSION_TOKEN:-}"
DOTBLUE_S3_FORCE_PATH_STYLE="${DOTBLUE_S3_FORCE_PATH_STYLE:-false}"
DOTBLUE_S3_AUTO_CREATE_BUCKET="${DOTBLUE_S3_AUTO_CREATE_BUCKET:-false}"
...
mkdir -p "${DOTBLUE_FILES_HOST_PATH_ABS}"
...
files:
  driver: "${DOTBLUE_FILES_DRIVER}"
  localRoot: "${DOTBLUE_FILES_LOCAL_ROOT}"
  s3:
    endpoint: "${DOTBLUE_S3_ENDPOINT}"
    region: "${DOTBLUE_S3_REGION}"
    bucket: "${DOTBLUE_S3_BUCKET}"
    accessKey: "${DOTBLUE_S3_ACCESS_KEY}"
    secretKey: "${DOTBLUE_S3_SECRET_KEY}"
    sessionToken: "${DOTBLUE_S3_SESSION_TOKEN}"
    forcePathStyle: ${DOTBLUE_S3_FORCE_PATH_STYLE}
    autoCreateBucket: ${DOTBLUE_S3_AUTO_CREATE_BUCKET}
